...
def interpolation_wheel_position(new_array_wheel_position, position_gamepad_value, array_wheel_pos):
    ...
    if delta_values > 0.3:
        delta = 1.1
    elif delta_values > 0.2:
        delta = 1.2
    elif delta_values > 0.1:
        delta = 1.3
    elif delta_values > 0.01:
        delta = 1.6
    else:
        delta = 2
...
# def interpolation_wheel_position(new_array_wheel_position, position_gamepad_value, array_wheel_pos):
#     # delta = 1
#     if abs(new_array_wheel_position[-1] - position_gamepad_value[1].item()) > 0.3:
#         delta = 0.9
#     elif abs(new_array_wheel_position[-1] - position_gamepad_value[1].item()) > 0.2:
#         delta = 1
#     elif abs(new_array_wheel_position[-1] - position_gamepad_value[1].item()) > 0.1:
#         delta = 1.2
#     elif abs(new_array_wheel_position[-1] - position_gamepad_value[1].item()) > 0.01:
#         delta = 1.4
#     elif abs(new_array_wheel_position[-1] - position_gamepad_value[1].item()) > 0.001:
#         delta = 1.6
#     else:
#         delta = 1.8
...
def main_code():
    ...
    array_wheel_pos = [i / 100 for i in range(0, 67, 3)]
    ...
    try:
        while True:
            ...
            # pygame.event.pump()
            # virtual_wheel.left_joystick_float(x_value_float=user_wheel.get_axis(0), y_value_float=0.0)
            # virtual_wheel.update()
            ...
            if keyboard.is_pressed(f'{third_key}'):
                ...
                x = [0.0, 0.2, 0.2, 0.4, 0.2, 0.0, -0.2, -0.4, -0.2, 0.0]
                for xi in x:
