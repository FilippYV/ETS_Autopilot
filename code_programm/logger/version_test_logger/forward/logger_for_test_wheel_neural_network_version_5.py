...
from code_programm.wheel_neural_network.forward.ver_4.wheel_neural_network_forward_4 import FeedforwardNet
...
def get_weight_model():
    ...
    wheel_net.load_state_dict(torch.load(get_path_weight_model('weight_wheel_nn_forward_4.pth')))
